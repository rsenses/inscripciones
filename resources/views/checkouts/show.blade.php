                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-12 col-sm-12">
                        <div class="form-group form-check">
                            ...
                            <label class="form-check-label" for="legal">He leído y acepto los <a href="{{ route('terminos-y-condiciones') }}?c={{ $checkout->id }}">términos y condiciones generales de la compra</a>.</label>
                        </div>
                        <p class="small">
