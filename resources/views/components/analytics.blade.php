<script type="text/javascript">
    ...
    (function(a,b,c,d){
        a='https://tags.tiqcdn.com/utag/unidadeditorial/{{ $campaign->partner->slug === "marca" ? "eventosue" : ($campaign->partner->slug === "diariomedico" ? "profsanitarios" : $campaign->partner->slug) }}/prod/utag.js';
