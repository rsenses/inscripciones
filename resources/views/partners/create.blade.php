        ...
        <form action="{{ route('partners.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-row align-items-end mb-4">
                <div class="col">
                    ...
                    <textarea name="conditions" id="conditions" cols="30" rows="10" class="form-control form-control-lg{{ $errors->has('conditions') ? 'is-invalid' : '' }}">{{ old('conditions') }}</textarea>
                ...
                <div class="col">
                    ...
                    <textarea name="legal" id="legal" cols="30" rows="10" class="form-control form-control-lg{{ $errors->has('legal') ? 'is-invalid' : '' }}">{{ old('legal') }}</textarea>
                    @if ($errors->has('legal'))
