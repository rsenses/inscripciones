...
<body>
    ...
    <p>Para tus inscripciones online, podrás acceder al streaming mediante tu usuario y contraseña desde:</p>
    <p><a href="{{ $checkout->campaign->url }}" target="_blank">{{ $checkout->campaign->url }}</a></p>
    @endif
    @endif
